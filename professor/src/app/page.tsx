...
export default function CopilotKitPage() {
  ...
  const [url, setUrl] = useState("https://docs.copilotkit.ai/langgraph/generative-ui/frontend-tools");
  ...
  useFrontendTool({
    ...
    parameters: [
      {
        name: "changepageUrl",
        description: "The URL to change the page to.",
        required: true,
      },
    ],
    handler({ changepageUrl }) {
      setUrl(changepageUrl);
    },
  });
